...
def read_fielddata():
    ...
    gdf_pl3 = gpd.read_file("APA2021_offered.shp")
...
#            if len(dsc_map2)!=0 :
            ...
            lat = dsc_map2.center_point.map(lambda p: p.y)
    # center on the middle of the field
            m = folium.Map(width=380,height=500,location=[lat, lon], tiles='cartodbpositron', zoom_start=7)
...
if __name__ == "__main__":
    st.set_page_config(page_title="APA-2022", page_icon='logo.jpg', layout='wide', initial_sidebar_state='auto')
    _max_width_()
